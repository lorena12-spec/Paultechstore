...
export default function ProductDetail({ product }: { product: any }) {
  ...
  const safeImages = images.length ? images : ["/images/placeholder-product.jpg"];
